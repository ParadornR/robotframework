...
As a user, I want to register
    When user register to future skill platform with ${username} ${firstName} ${lastName} ${phoneNumber} ${password} ${confirmPassword}
    Then future skill should display otp message as "ระบบได้ส่งรหัส OTP ไปยังเบอร์โทรศัพท์"
